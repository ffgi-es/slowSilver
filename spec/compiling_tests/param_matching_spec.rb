...
describe 'compiling and running program' do
  ...
  it 'should return 28 for params_matching3.sag.sag' do
  ...
  it 'should return 24 for params_matching4.sag.sag' do
  ...
  it 'should return 1 for params_matching5.sag.sag' do
